...
export default function TripPlanner({ onNavigate, onSelectStation }: TripPlannerProps) {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute top-full right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 z-[1000] p-4 max-h-[80vh] overflow-y-auto">
